...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'Dota 2 ELO Team Rankings 2026', description: 'Dota 2 ELO team rankings updated after every Tier 1 series. Weighted by opponent strength — a live snapshot of which teams are actually performing right now.', url: '/rankings', images: [{ url: 'https://www.dota2protips.com/1.png', width: 512, height: 512, alt: 'Dota2ProTips' }] },
            ...
            {inactiveTeams.map((team, idx) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="font-semibold text-sm">{team.name}</div>
                  {team.region && <div className="text-xs" style={{ color: 'var(--text-muted)' }}>{team.region}</div>}
                </div>
