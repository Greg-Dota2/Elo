  ...
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="text-center mb-12">
        <p className="section-label mb-3">Переходы</p>
        <h1 className="font-display text-4xl font-black tracking-tight mb-4">Трансферные новости</h1>
        <p className="text-base leading-7 max-w-xl mx-auto" style={{ color: 'var(--text-muted)' }}>
          Все заметные изменения составов в про сцене Dota 2 — подписания, уходы, аренды и завершения карьеры.
          Обновляется по мере появления новостей.
        </p>
      </div>
      ...
      {transfers.length === 0 ? (
        <div className="rounded-2xl p-10 text-center" style={{ background: 'var(--surface)', border: '1px solid var(--border)' }}>
          ...
          <p className="font-semibold mb-1">Трансферов пока нет</p>
          <p className="text-sm" style={{ color: 'var(--text-muted)' }}>Заходите позже, когда начнётся следующий трансферный период.</p>
        </div>
      ) : (
