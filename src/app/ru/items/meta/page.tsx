...
import ItemMetaClient, { type UpgradeItemStat, type NeutralItemEntry } from '@/app/items/meta/ItemMetaClient'
...
export default async function RuItemMetaPage() {
  ...
  return <ItemMetaClient upgradeItems={upgradeItems} neutralItems={neutralItems} updatedAt={updatedAt} itemPrefix="/ru/items" locale="ru" />
}
